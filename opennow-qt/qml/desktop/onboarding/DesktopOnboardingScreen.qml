            ...
            Card {
                ...
                Repeater {
                    model: [
                        ...
                        {glyph:"bolt",label:qsTr("Boost"),step:3,value:(root.settings.frameGeneration === "2x" ? qsTr("Frame generation 2× · Experimental") : root.settings.frameGeneration === "auto" ? qsTr("Frame generation auto 60 · Experimental") : qsTr("Frame generation off"))
